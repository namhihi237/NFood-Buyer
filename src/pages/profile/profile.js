    ...
    <View style={styles.mainContainer}>
      <View style={styles.header}>
        ...
        <View style={styles.info}>
          <Image source={{ uri: data ? data?.getUser.image || noImage : noImage }} style={styles.avatar} />
          <View >
      ...
      <View >
        ...
        <TouchableWithoutFeedback onPress={() => navigation.navigate(SCREEN.MANAGE_PROFILE, { user: data?.getUser })}>
          <View style={styles.ordersHeader} >
            <View style={styles.ordersHeaderLeft}>
              <FontAwesome5 name="user" size={hp('2.6%')} color="#000" style={{ marginRight: 10 }} />
